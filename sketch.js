...
var sad_sound;
var eating_sound;
var starImg,starsImg,emptyImg,star1_Img,blowerImg;
function preload()
{
  ...
  star1_Img = loadAnimation('one_star.png');
...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   stars = createSprite(50,35,30,30);
   stars.addAnimation("2Stars",starsImg);
   stars.scale = 0.2
   stars.addAnimation("empty",emptyImg);
   stars.addAnimation("1star",star1_Img);
